...
class CustomPraesidiumAdapter (val ctx : Context, val arrayList:ArrayList<PraesidiumViewModel>) : RecyclerView.Adapter<CustomPraesidiumAdapter.CustomView>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomView {
        ...
        val praesidiumBinding:PraesidiumBinding = DataBindingUtil.inflate(layoutInflater, R.layout.innerpraesidiumlayout, parent, false)
        val praesidiumView = layoutInflater.inflate(R.layout.innerpraesidiumlayout, parent, false)
