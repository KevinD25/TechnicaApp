...
class CustomPartnerAdapter(val ctx : Context, val arrayList:ArrayList<SponsorsViewModel>) : RecyclerView.Adapter<CustomPartnerAdapter.CustomView>() {
    ...
    class CustomView(val partnerBinding: PartnerBinding, v: View, arrayList: ArrayList<SponsorsViewModel>, ctx: Context): RecyclerView.ViewHolder(partnerBinding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomView {
        ...
        return CustomPartnerAdapter.CustomView(partnerBinding, partnerView, arrayList, ctx)
    }
